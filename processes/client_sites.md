...
layout: default
title: Client Sites
subhead: From Closed Deal to Launched Site
parent: Processes
has_children: false
...
<mark>Building things for yourself is hard. Building for someone else is harder.</mark>

Always think of Engine Client sites as opportunities for brand expression and improvements upon each previous theme we’ve built. What Engine does with each theme is largely the same, but should always be seen as a chance to express the brand and improve on conversion and push the limits of site design.

---

## Assemble a Client Site Steering Team
...
* **An Internal Decider on behalf of the Client**

  The Decider owns the success or failure of the product launch. <mark>The Internal Decider is the ultimate holder and arbiter of *features* and *deadlines*.</mark> They say things like, "The client needs {this}," "That’s a feature for post-launch," or "Cut {feature} in order to launch the client site by {date}." The internal decider represents the needs and wants of the client. This is usually a Client Success Manager.

* **An appointed Client Decider**

  The Client Decider has final say in approving or revising items for the client site. They say things like, “The problem we need to solve for my brand is {this},” “That’s a feature I’d really like to have,” or “I really want the site to do {this}”

* **A Project Manager**

  The PM takes feedback from different directions in order to analyze and communicate progress toward deadlines to the Decider, Client and the team. The PM is responsible for monitoring and clearly communicating progress to the Client.
